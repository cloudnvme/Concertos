...
<div class="box container">
    ...
    <div class="comments col-md-12">
      ...
      <li class="media" style="border-left: 5px solid #01BC8C">
        ...
        <strong>{{ str_upper(trans('common.anonymous')) }} @if(\App\Policy::isModerator(auth()->user()))<a href="{{ route('profile', ['id' => $comment->user->id]) }}">({{ $comment->user->username }})</a>@endif</strong>
        @else
        ...
        @if($comment->user_id == auth()->user()->id || \App\Policy::isModerator(auth()->user()))
