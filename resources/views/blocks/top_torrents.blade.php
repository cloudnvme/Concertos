<div class="col-md-10 col-sm-10 col-md-offset-1">
  ...
  <div class="panel panel-chat shoutbox">
    ...
    <i class="fa fa-recycle text-red" data-toggle="tooltip" title="" data-original-title="{{ trans('blocks.requires-reseed') }}"></i></a></li>
      <li class=""><a href="#deadtorrents" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-exclamation-triangle text-red"></i> {{ trans('torrent.dead-torrents') }}
    <i class="fa fa-recycle text-red" data-toggle="tooltip" title="" data-original-title="{{ trans('blocks.requires-reseed') }}"></i></a></li>
    </ul>
    ...
    {{ $t->name }}
      ...
      {{ $b->name }}
                    ...
                    <div>
                      ...
                      @if($b->stream == "1")<span class="badge-extra"><i class="fa fa-play text-red text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('torrent.stream-optimized') }}"></i> {{ trans('torrent.stream-optimized') }}</span> @endif
                      @if($b->doubleup == "1")<span class="badge-extra"><i class="fa fa-diamond text-green text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('torrent.double-upload') }}"></i> {{ trans('torrent.double-upload') }}</span> @endif
                      @if($b->free == "1")<span class="badge-extra"><i class="fa fa-star text-gold text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('torrent.freeleech') }}"></i> {{ trans('torrent.freeleech') }}</span> @endif
                      @if(config('other.freeleech') == true)<span class="badge-extra"><i class="fa fa-globe text-blue text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('common.global') }} {{ trans('torrent.freeleech') }}"></i> {{ trans('common.global') }} {{ trans('torrent.freeleech') }}</span> @endif
                      @if(config('other.doubleup') == true)<span class="badge-extra"><i class="fa fa-globe text-green text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('common.global') }} {{ trans('torrent.double-upload') }}"></i> {{ trans('common.global') }} {{ trans('torrent.double-upload') }}</span> @endif
                      @if($b->leechers >= "5") <span class="badge-extra"><i class="fa fa-fire text-orange text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('common.hot') }}"></i> {{ trans('common.hot') }}</span> @endif
                      @if($b->sticky == 1) <span class="badge-extra"><i class="fa fa-thumb-tack text-black text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('common.sticked') }}"></i> {{ trans('common.sticked') }}</span> @endif
                      @if($b->highspeed == 1)<span class="badge-extra"><i class="fa fa-tachometer text-red text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('common.high-speeds') }}"></i> {{ trans('common.high-speeds') }}</span> @endif
                    </div>
                  </div>
                </td>
                <td>
      ...
      {{ $l->name }}
                    ...
                    <div>
                      ...
                      @if($l->stream == "1")<span class="badge-extra"><i class="fa fa-play text-red text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('torrent.stream-optimized') }}"></i> {{ trans('torrent.stream-optimized') }}</span> @endif
                      @if($l->doubleup == "1")<span class="badge-extra"><i class="fa fa-diamond text-green text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('torrent.double-upload') }}"></i> {{ trans('torrent.double-upload') }}</span> @endif
                      @if($l->free == "1")<span class="badge-extra"><i class="fa fa-star text-gold text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('torrent.freeleech') }}"></i> {{ trans('torrent.freeleech') }}</span> @endif
                      @if(config('other.freeleech') == true)<span class="badge-extra"><i class="fa fa-globe text-blue text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('common.global') }} {{ trans('torrent.freeleech') }}"></i> {{ trans('common.global') }} {{ trans('torrent.freeleech') }}</span> @endif
                      @if(config('other.doubleup') == true)<span class="badge-extra"><i class="fa fa-globe text-green text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('common.global') }} {{ trans('torrent.double-upload') }}"></i> {{ trans('common.global') }} {{ trans('torrent.double-upload') }}</span> @endif
                      @if($l->leechers >= "5") <span class="badge-extra"><i class="fa fa-fire text-orange text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('common.hot') }}"></i> {{ trans('common.hot') }}</span> @endif
                      @if($l->sticky == 1) <span class="badge-extra"><i class="fa fa-thumb-tack text-black text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('common.sticked') }}"></i> {{ trans('common.sticked') }}</span> @endif
                      @if($l->highspeed == 1)<span class="badge-extra"><i class="fa fa-tachometer text-red text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('common.high-speeds') }}"></i> {{ trans('common.high-speeds') }}</span> @endif
                    </div>
                  </div>
                </td>
                <td>
      ...
      {{ $d->name }}
                    ...
                    <div>
                      ...
                      @if($d->stream == "1")<span class="badge-extra"><i class="fa fa-play text-red text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('torrent.stream-optimized') }}"></i> {{ trans('torrent.stream-optimized') }}</span> @endif
                      @if($d->doubleup == "1")<span class="badge-extra"><i class="fa fa-diamond text-green text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('torrent.double-upload') }}"></i> {{ trans('torrent.double-upload') }}</span> @endif
                      @if($d->free == "1")<span class="badge-extra"><i class="fa fa-star text-gold text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('torrent.freeleech') }}"></i> {{ trans('torrent.freeleech') }}</span> @endif
                      @if(config('other.freeleech') == true)<span class="badge-extra"><i class="fa fa-globe text-blue text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('common.global') }} {{ trans('torrent.freeleech') }}"></i> {{ trans('common.global') }} {{ trans('torrent.freeleech') }}</span> @endif
                      @if(config('other.doubleup') == true)<span class="badge-extra"><i class="fa fa-globe text-green text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('common.global') }} {{ trans('torrent.double-upload') }}"></i> {{ trans('common.global') }} {{ trans('torrent.double-upload') }}</span> @endif
                      @if($d->leechers >= "5") <span class="badge-extra"><i class="fa fa-fire text-orange text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('common.hot') }}"></i> {{ trans('common.hot') }}</span> @endif
                      @if($d->sticky == 1) <span class="badge-extra"><i class="fa fa-thumb-tack text-black text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('common.sticked') }}"></i> {{ trans('common.sticked') }}</span> @endif
                      @if($d->highspeed == 1)<span class="badge-extra"><i class="fa fa-tachometer text-red text-bold" data-toggle="tooltip" title="" data-original-title="{{ trans('common.high-speeds') }}"></i> {{ trans('common.high-speeds') }}</span> @endif
                    </div>
                  </div>
                </td>
                <td>
