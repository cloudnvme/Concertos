            ...
            <table class="f-display-topics table col-md-12">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="f-display-topic-started"><a href="{{ route('profile', ['id' => $t->first_post_user_id]) }}">{{ $t->first_post_user_username }}</a></td>
                        ...
                        <td class="f-display-topic-last-post">
                            <a href="{{ route('profile', ['id' => $t->last_post_user_id]) }}">{{ $t->last_post_user_username }}</a> on <time datetime="{{ date('M d Y', strtotime($last_post->created_at)) }}">
