            ...
            <div class="block">
                <div class="row">
                  <div class="col-md-8 col-xs-5">
                    <div class="btn-group">
                      <a href="{{ route('mark-all-read', array('id' => auth()->user()->id)) }}">
                  ...
                  <form role="form" method="POST" action="{{ route('searchPM',['id' => $user->id]) }}">
                  {{ csrf_field() }}
          ...
          <table class="table table-striped table-hover table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="col-sm-2"><a href="{{ route('profile', ['id' => $p->sender->id]) }}" title="">{{ $p->sender->username}}</a></td>
